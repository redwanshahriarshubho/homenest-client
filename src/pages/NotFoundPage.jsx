...
const NotFoundPage = () => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 py-12 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      <div className="text-center max-w-md">
        ...
        <div className="space-x-4">
          ...
          <Link to="/properties" className="block text-blue-600 hover:underline">Browse Properties</Link>
        </div>
      </div>
    </div>
  );
