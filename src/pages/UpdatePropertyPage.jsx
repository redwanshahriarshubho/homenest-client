    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Update Property</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 rounded-lg shadow-lg bg-white dark:bg-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block mb-2 font-semibold text-gray-900 dark:text-white">User Email (Read-only)</label>
              <input
                type="email"
                value={user?.email || ''}
                readOnly
            ...
            <div>
              <label className="block mb-2 font-semibold text-gray-900 dark:text-white">User Name (Read-only)</label>
              <input
                type="text"
